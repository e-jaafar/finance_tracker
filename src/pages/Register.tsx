        ...
        <div className="min-h-screen bg-[#16161d] flex items-center justify-center p-4 selection:bg-slate-700 selection:text-white font-sans text-white">
            <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 mt-2 text-sm">Start your financial journey today</p>
                </div>
                ...
                <div className="rounded-2xl border border-white/5 bg-[#1e1e26] p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="block text-xs font-semibold text-slate-400 mb-2 ml-1 uppercase tracking-wider">Email Address</label>
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-slate-400 mb-2 ml-1 uppercase tracking-wider">Password</label>
                            <div className="relative group">
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-slate-400 mb-2 ml-1 uppercase tracking-wider">Confirm Password</label>
                            <div className="relative group">
                                <Lock className="absolute left-4 top-3.5 text-slate-500 group-focus-within:text-white transition-colors" size={18} />
                                <input
                                    type="password"
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-[#1e1e26] px-2 text-slate-500 font-medium">Or join with</span>
                            </div>
                        </div>
                ...
                <div className="text-center mt-8">
                    <p className="text-sm text-slate-500">
                        ...
                        <Link to="/login" className="font-semibold text-white hover:text-slate-300 hover:underline transition-colors">
                            Log In
                        </Link>
                    </p>
                </div>
